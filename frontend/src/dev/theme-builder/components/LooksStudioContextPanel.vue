...
.looks-context__advanced{margin-top:16px;padding-top:12px;border-top:1px solid var(--builder-border);color:var(--builder-muted);font-size:.62rem}.looks-context__advanced summary{cursor:pointer;color:var(--builder-faint);letter-spacing:.04em;transition:color var(--builder-control-transition),transform var(--builder-control-transition)}.looks-context__advanced summary:hover{color:var(--builder-text);transform:translateX(2px)}.looks-context__advanced[open] dl{animation:builder-disclosure-in var(--builder-panel-transition) both}.looks-context__advanced dl{display:grid;margin:10px 0 0;gap:7px}.looks-context__advanced dl div{display:grid;grid-template-columns:58px minmax(0,1fr);gap:8px}.looks-context__advanced dt{color:var(--builder-faint)}.looks-context__advanced dd{margin:0;overflow-wrap:anywhere;color:var(--builder-muted)}
</style>
