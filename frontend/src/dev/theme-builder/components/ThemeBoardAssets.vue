...
.theme-assets__grid article { display: grid; min-width: 0; padding: 11px; grid-template-columns: 86px minmax(0, 1fr); border: 1px solid rgba(154,174,191,.14); border-radius: var(--builder-radius-card); background: linear-gradient(145deg, rgba(23,30,36,.88), rgba(13,18,23,.74)); box-shadow: inset 0 1px rgba(255,255,255,.018); gap: 12px; transition:border-color var(--builder-control-transition),box-shadow var(--builder-panel-transition),transform var(--builder-control-transition); }
.theme-assets__grid article:hover { border-color:rgba(120,149,177,.25); box-shadow:var(--builder-shadow-card),inset 0 1px rgba(255,255,255,.025); transform:translateY(-2px); }
