...
.studio-rail__brand { width:72px;height:64px;color:var(--builder-text); }
...
.studio-rail__studios { display:flex;flex-direction:column;gap:8px; }
.studio-rail__item { position:relative;width:48px;height:48px;border:1px solid transparent;border-radius:10px;color:#9c9da0;transition:color var(--builder-control-transition),border-color var(--builder-control-transition),background var(--builder-control-transition),box-shadow var(--builder-control-transition); }
...
.studio-rail__item--active { border-color:rgba(120,149,177,.55);background:linear-gradient(145deg,rgba(120,149,177,.16),rgba(120,149,177,.05));box-shadow:inset 0 0 18px rgba(120,149,177,.08),0 0 18px rgba(120,149,177,.1);color:var(--builder-text); }
