...
defineProps<{ skinName: string; partName: string; partId: string; stateLabel: string; fill: string; stroke: string; opacity: number; textureRef: string; assets: readonly Readonly<BuilderAssetPresentation>[] }>();
